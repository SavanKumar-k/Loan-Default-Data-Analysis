# Loan Default Data Analysis (Interactive Dashboard creation using PowerBi+Sequel Server[Data Source : Dataflows])
## Project Overview
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/9e96c9cb-57c1-46d9-ac98-cccd168cc937" alt="img3" width="900" />
</p>
...
- Which loan purposes contribute most to defaults?

- How does employment type influence loan amount and default rate?

- What is the average loan amount by age group?

- How do default rates vary year over year?

- How does credit score affect median and total loan amounts?

- Which borrower segments (age, marital status, mortgage/dependents) take higher loans?

- How does education level relate to the number of loans?

- What are the YoY changes in loan amounts and defaults?

- How do credit score bins and marital status impact year-to-date loan amounts?
...
- Dashboard Intearaction report1 - <a href="https://github.com/SavanKumar-k/Loan-Default-Data-Analysis/blob/main/img1.png" > View Dashboard</a>
- Dashboard Intearaction report2 - <a href="https://github.com/SavanKumar-k/Loan-Default-Data-Analysis/blob/main/im2.png " > View Dashboard</a>
- Dashboard Intearaction report3 - <a href="https://github.com/SavanKumar-k/Loan-Default-Data-Analysis/blob/main/im3.png" > View Dashboard</a>
